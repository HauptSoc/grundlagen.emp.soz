...
execute: 
  echo: false
resources: 
  - reading_guide/reading-guide/week-6-reading.docx
---
...
Download the reading guide as a [Word Document here](reading-guide/week-6-reading.docx)
...
2.  $R^2$ values of 1 tell us that our model explains 100% of the variation in $y$. Say we fit a model to the Massachusetts high school data and obtained $R^2 = 1$. This would be telling us that the combination of explanatory variables ($x$) we used and model form we chose (interaction or parallel slopes) explains 100% of the variation in the SAT math scores. Or, in other words, the combination of explanatory variables ($x$) we used and model form we chose tell us **everything** we need to know about average math SAT scores.
