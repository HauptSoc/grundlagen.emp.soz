...
-   Write out the estimated regression equation for your statistical model.
    ...
    -   For your regression equation, you can either use indicator variables for each level of the categorical variable *or* write out a different equation for each group.
