...
![](images/faktor-ausprägung-variablen.svg)

## Auswahl von Indikatoren {.midi}
...
1.  Die Indikatoren müssen die volle **Bandbreite** der (theoretisch postulierten) Unterschiede (= Dimensionen + Ausprägungen) erfassen können.[^1]
