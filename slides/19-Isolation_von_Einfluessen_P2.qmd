...
- Ein typisches[^1] Regressionsmodell bezieht sich immer auf **direkte** Einflüsse auf **ein** Outcome. 
...
| $\hat{\alpha}$   	| alpha    	| Durchschnittliche Anzahl bisheriger Beziehungen für die Referenzgruppe                                                                    	|
...
- Die durchschnittliche Anzahl bisheriger Partnerschaften sinkt um 0.43 Partner*innen für jedes Jahr, in dem der erste GV später statt fand. 
...
$$\hat{\alpha}=\bar{y}-\hat{\beta} \bar{x} = 1.9 - (-0.428)*18.8 = 9.94$$

**Golem-Alarm**[^3]: Die Basisgruppe sind in diesem Modell Personen *ohne Einfluss des Alters des ersten GV*.  Wir erwarten daher für Personen, die mit null Jahren zum ersten mal freiwillig! GV hatten, eine durchschnittliche Anzahl von 9.94 bisherigen Partnern.  

[^3]: Das ist natürlich eine reichlich sinnlose Information. Das ist aber unserem Modell egal! 
