...
ggplot(data = penguins, mapping = aes(x = bill_length_mm)) + 
  geom_histogram(binwidth = 1.5, color = "white", fill = "darkgray") +
  labs(x = "Bill Length (mm)") + 
  my_theme
```
...
::: {.midi}
**Step 1**: Go to [What's Going on in this Graph](https://www.nytimes.com/column/whats-going-on-in-this-graph) and pick a visualization to critique

**Step 2:** Choose between the two scientific papers provided (to focus on for 
your Statistical Critiques)

**Step 3:** Choose a visualization from the paper to critique

**Step 4:** Complete the [Statistical Critique](/critique/critique-1.qmd)!
:::
