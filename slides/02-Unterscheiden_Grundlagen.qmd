...
## Die Bedeutung guter Konzepte
 ...
 - Klare Beschreibungen benötigen klare Konzepte, da eine Beschreibung die Einordnung einer Beobachtung *B* unter ein Konzept *K* der Form "B ist eine Realisation von K" ist. 
  -  Wenn Sie Eigenschaften oder Ausprägungen *A* und *B*  voneinander unterscheiden wollen, müssen Sie spezifizieren, welche Intension *A* hat, die *B* nicht hat. Dazu müssen wir *A* und *B* nicht erschöpfend beschreiben. Wir benötigen "nur" eine klare Trenn-Eigenschaft. 
  
  
## Beschreibung von Dingen

![Ein Zeitschriftenständer](https://fintabo.de/images/product_images/popup_images/prospektstaender_880_0.webp)

## Beschreibung von Dingen

![Ein römischer Dodekaeder](https://upload.wikimedia.org/wikipedia/commons/thumb/5/54/Pentagon-dodeca%C3%ABder_in_brons%2C_150_tot_400_NC%2C_vindplaats-_Tongeren%2C_Leopoldwal%2C_1939%2C_collectie_Gallo-Romeins_Museum_Tongeren%2C_4002.jpg/1024px-Pentagon-dodeca%C3%ABder_in_brons%2C_150_tot_400_NC%2C_vindplaats-_Tongeren%2C_Leopoldwal%2C_1939%2C_collectie_Gallo-Romeins_Museum_Tongeren%2C_4002.jpg){width=50%}
...
::::{.column width="50%"}
 ![](images/hikikomori.png)
::::

::::{.column width="50%"}
Hikikomori[^1] - ist das eine Form von Isolation, Zurückgezogenheit, (maximale) Introvertiertheit, Depression?
...
## Die (soziale) Welt ist bunt

![](images/cohen-single-family.png){width=120%}

## Ist das ein Auto?

![Der Fiat Topolino. Bildquelle: Wikipedia](https://upload.wikimedia.org/wikipedia/commons/d/d7/Fiat_Topolino_%282023%29_IMG_0749.jpg){width="70%"}
...
## Armut und der Reichtum an Begriffen {.midi}

![Konzepte von Armut im internationalen Vergleich. Quelle: Our World in Data](https://ourworldindata.org/cdn-cgi/imagedelivery/qLq-8BTgXU8yG0N6HnOy8g/63d8e4f5-b1f3-4847-7981-b9de18260500/w=850){width=70%}

## Macht es einen Unterschied? 

<iframe src="https://ourworldindata.org/explorers/poverty-explorer?Indicator=Share+in+poverty&Poverty+line=%243+per+day%3A+International+Poverty+Line&Household+survey+data+type=Show+data+from+both+income+and+consumption+surveys&Show+breaks+between+less+comparable+surveys=false&country=BGD~BOL~KEN~MOZ~NGA~ZMB&tab=map&hideControls=false" loading="lazy" style="width: 100%; height: 600px; border: 0px none;" allow="web-share; clipboard-write"></iframe>
