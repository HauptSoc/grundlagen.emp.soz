...
> These data were retrieved in 2008 and 2009 from [Gapminder](https://gapminder.org/), and manually cleaned by Dr. Jenny Bryan and her STAT 545 students.
...
visualise(null_dist) +
  labs(x = "Permuted Slope Statistics")
```
...
*Hint: You'll want to use the `gapminder_lm` object (model) you fit in #3.*
